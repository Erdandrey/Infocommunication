...
namespace Linq_Student
{
    class Program
    {
        ...
        static List<Student> students = new List<Student>
        {
            ...
            new Student {First="Indigo", Last="Deboia", ID=116, Scores= new List<int> {40, 93, 88, 72}},
            new Student {First="Alisia", Last="Validensi", ID=117, Scores= new List<int> {99, 66, 99, 66}},
        };
    }
}
